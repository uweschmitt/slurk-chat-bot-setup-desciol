...
from slurk.views.api.openvidu.fields import (
    IntegerOrNone,
    List,
    Resolution,
    SessionId,
...
class RecordingConfigSchema(BaseSchema):
    version = ma.fields.String(description="Version of the recording")
...
class ConfigSchema(BaseSchema):
    version = ma.fields.String(description="Version of the OpenVidu Server")
    ...
    public_url = ma.fields.String(description="URL where OpenVidu Server is available")
    cdr = ma.fields.Boolean(description="Call Detail Record is enabled")
    streams = ma.fields.Nested(
        StreamsConfigSchema, description="Configuration for streams"
    )
    sessions = ma.fields.Nested(
        SessionsConfigSchema, description="Default configuration for sessions"
    )
    ...
    webhook = ma.fields.Nested(
        WebhookConfigSchema, allow_none=True, description="Configuration for webhooks"
    )


class DefaultRecordingPropertiesSchema(BaseSchema):
    name = String(missing=None, description="Name of the Recording")
    ...
    resolution = Resolution(
        missing="1280x720", description="Resolution of the video file"
    )
...
class RecordingPropertiesSchema(BaseSchema):
    id = ma.fields.String(dump_only=True, description="Identifier of the Recording")
...
class VideoDimensionsSchema(BaseSchema):
    width = ma.fields.Integer(description="Width of the video")
    height = ma.fields.Integer(description="Height of the video")
...
class MediaOptionsSchema(BaseSchema):
    ...
    typeOfVideo = ma.fields.String(
        data_key="type_of_video", dump_only=True, description="The type of video"
    )
    filter = ma.fields.Dict(dump_only=True, description="Filter used for the stream")


class PublisherSchema(BaseSchema):
    streamId = ma.fields.String(
        data_key="stream_id", dump_only=True, description="Identifier of the stream"
    )
    createdAt = Timestamp(
        data_key="created_at",
        dump_only=True,
...
class ConnectionSchema(BaseSchema):
    id = ma.fields.String(dump_only=True, description="Identifier of the Connection")
    ...
    token = ma.fields.String(dump_only=True, description="Token of the Connection")
...
class SessionSchema(BaseSchema):
    id = ma.fields.String(dump_only=True, description="Identifier of the session")
    createdAt = Timestamp(
        data_key="created_at",
        dump_only=True,
...
class SignalSchema(BaseSchema):
    ...
    type = ma.fields.String(description="Type of the signal")
    data = ma.fields.String(description="Actual data of the signal")
